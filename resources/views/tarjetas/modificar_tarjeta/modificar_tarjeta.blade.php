<div>
	<div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				...
				<div class="col-md-6">
					<input class="form-control" type="number" id="saldo_actual" name="" value="" placeholder="Saldo inicial">
				</div>
				<div class="col-md-12">
	...
	<script type="text/javascript" src="{{ asset('js/tarjetas/modificar_tarjeta.js') }}"></script>
</div>