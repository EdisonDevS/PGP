<div>
	<div class="row">
		...
		<div class="col-md-4">
			<div class="col-md-12">
				<p style="padding-top: 3px; margin-bottom: 35px">Tipo de tarjeta:</p>
			</div>
		</div>
		<div class="col-md-4">
			<div class="col-md-12">
				<p style="padding-top: 3px; margin-bottom: 35px">Saldo de la tarjeta:</p>
			</div>
		</div>
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-5">
					<div class="row">
						<div class="col-md-5">
							<p style="padding-top: 5px">Fecha programada:</p>
						</div>
						<div class="col-md-7">
		...
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-6">
					<input class="form-control" type="text" name="" value="" placeholder="Número de cuenta">
				</div>
				<div class="col-md-6">
					<select class="form-control"	>
